...
<section class=gift_parties_container>
    <div class="gift_parties_top">
        ...
        <p>We make it easy to share la passion du macaron with your friends, family and colleagues. Choose from our
            array of premium gift options, or we can create a custom solution.
            Contact us when you need help planning your celebration! <span>orders@mboutique.com</span></p>
    </div>
    <div class="gift_parties_bottom">
        <div class="gift_parties_giftboxes">
            <h3>Gift boxes</h3>
        ...
        <div class="gift_parties_partytower">
            <h3>Party tower</h3>
